...
//    }
    ...
    void testExpressionStatement() {
        ...
        Ast.Expression log1 = new Ast.Expression.Function("log", Arrays.asList(
                new Ast.Expression.Literal(BigInteger.ONE)
        ));
        Ast.Expression log2 = new Ast.Expression.Function("log", Arrays.asList(
                new Ast.Expression.Literal(BigInteger.valueOf(2))
        ));
        Ast.Expression sum = new Ast.Expression.Binary("+", log1, log2);
        test(new Ast.Statement.Expression(sum), Environment.NIL.getValue(), scope);
